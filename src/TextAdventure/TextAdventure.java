...
public class TextAdventure {
    ...
    public static void main(String[] args) {
        ...
        //Room 6 (First Floor)
        Room firstFloor = new Room("First Floor", "A long hallway with a common area to your right, stairs that lead down to the basement, and a door that leads to the street", exit10, exit11, exit12, exit13);
        ...
        //Room 9
        Room studyRoom = new Room("Study Area", "A quiet room, you realize you have studied here before. You notice a glint coming from one of the desks", exit15, studentID);
        ...
        Room street = new Room("Street", "A barren street with... what's that?? A giant fly blocks your path to the dining center!", exit16, exit15, giantFly);
        exit15.setRequiredItem(studentID);
        exit16.setCreatureBlocks(true);
